#!/usr/bin/env python
"""Main test file for Terminate Instances SSM document."""
...
SSM_DOC_NAME = PREFIX + 'automation-terminateinstance'
INSTANCE_CFN_STACK_NAME = PREFIX + 'automation-terminateinstance'
